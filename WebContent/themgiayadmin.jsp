...
<body>
	...
	<form action="themgiayadminController2" method="post" enctype="multipart/form-data"  class='form-container'>
		<div class="form-row">
			<div class="form-group col-md-12">
				<label for="inputEmail4">Mã Giày</label> <input type="text"
					name="mg" name="" class="form-control" id="inputEmail4"
					required="required">
			</div>
			<div class="form-group col-md-12">
				<label for="inputPassword4">Tên Giày</label> <input name="tg"
		...
		<button type="submit" class="btn btn-primary" name="btnSave">
			<i class="fa-solid fa-floppy-disk"></i> Thêm giày
		</button>
